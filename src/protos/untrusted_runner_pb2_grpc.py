...
class UntrustedRunnerStub(object):
  ...
  def __init__(self, channel):
    ...
    self.GetStatus = channel.unary_unary(
        ...
        request_serializer=protos_dot_untrusted__runner__pb2.GetStatusRequest
        .SerializeToString,
        response_deserializer=protos_dot_untrusted__runner__pb2
        .GetStatusResponse.FromString,
    )
    self.SetupRegularBuild = channel.unary_unary(
        "/UntrustedRunner/SetupRegularBuild",
        request_serializer=protos_dot_untrusted__runner__pb2
        .SetupRegularBuildRequest.SerializeToString,
        response_deserializer=protos_dot_untrusted__runner__pb2
        .SetupBuildResponse.FromString,
    )
    self.RunProcess = channel.unary_unary(
        "/UntrustedRunner/RunProcess",
        request_serializer=protos_dot_untrusted__runner__pb2.RunProcessRequest
        .SerializeToString,
        response_deserializer=protos_dot_untrusted__runner__pb2
        .RunProcessResponse.FromString,
    )
    self.RunAndWait = channel.unary_unary(
        "/UntrustedRunner/RunAndWait",
        request_serializer=protos_dot_untrusted__runner__pb2.RunAndWaitRequest
        .SerializeToString,
        response_deserializer=protos_dot_untrusted__runner__pb2
        .RunAndWaitResponse.FromString,
    )
    self.CreateDirectory = channel.unary_unary(
        "/UntrustedRunner/CreateDirectory",
        request_serializer=protos_dot_untrusted__runner__pb2
        .CreateDirectoryRequest.SerializeToString,
        response_deserializer=protos_dot_untrusted__runner__pb2
        .CreateDirectoryResponse.FromString,
    )
    self.RemoveDirectory = channel.unary_unary(
        ...
        response_deserializer=protos_dot_untrusted__runner__pb2
        .RemoveDirectoryResponse.FromString,
    )
    self.ListFiles = channel.unary_unary(
        "/UntrustedRunner/ListFiles",
        request_serializer=protos_dot_untrusted__runner__pb2.ListFilesRequest
        .SerializeToString,
        response_deserializer=protos_dot_untrusted__runner__pb2
    ...
    self.CopyFileTo = channel.stream_unary(
        ...
        request_serializer=protos_dot_untrusted__runner__pb2.FileChunk
        .SerializeToString,
        response_deserializer=protos_dot_untrusted__runner__pb2
        .CopyFileToResponse.FromString,
    )
    self.CopyFileFrom = channel.unary_stream(
        "/UntrustedRunner/CopyFileFrom",
        request_serializer=protos_dot_untrusted__runner__pb2.CopyFileFromRequest
        .SerializeToString,
        response_deserializer=protos_dot_untrusted__runner__pb2.FileChunk
        .FromString,
    )
    self.Stat = channel.unary_unary(
        "/UntrustedRunner/Stat",
        request_serializer=protos_dot_untrusted__runner__pb2.StatRequest
        .SerializeToString,
        response_deserializer=protos_dot_untrusted__runner__pb2.StatResponse
        .FromString,
    )
    self.UpdateEnvironment = channel.unary_unary(
        "/UntrustedRunner/UpdateEnvironment",
        request_serializer=protos_dot_untrusted__runner__pb2
        .UpdateEnvironmentRequest.SerializeToString,
        response_deserializer=protos_dot_untrusted__runner__pb2
        .UpdateEnvironmentResponse.FromString,
    )
    self.ResetEnvironment = channel.unary_unary(
        "/UntrustedRunner/ResetEnvironment",
        request_serializer=protos_dot_untrusted__runner__pb2
        .ResetEnvironmentRequest.SerializeToString,
        response_deserializer=protos_dot_untrusted__runner__pb2
        .ResetEnvironmentResponse.FromString,
    )
    self.UpdateSource = channel.unary_unary(
        "/UntrustedRunner/UpdateSource",
        request_serializer=protos_dot_untrusted__runner__pb2.UpdateSourceRequest
        .SerializeToString,
        response_deserializer=protos_dot_untrusted__runner__pb2
        .UpdateSourceResponse.FromString,
    )
    self.SymbolizeStacktrace = channel.unary_unary(
        "/UntrustedRunner/SymbolizeStacktrace",
        request_serializer=protos_dot_untrusted__runner__pb2
        .SymbolizeStacktraceRequest.SerializeToString,
        response_deserializer=protos_dot_untrusted__runner__pb2
        .SymbolizeStacktraceResponse.FromString,
    )
    self.TerminateStaleApplicationInstances = channel.unary_unary(
        "/UntrustedRunner/TerminateStaleApplicationInstances",
        request_serializer=protos_dot_untrusted__runner__pb2
        .TerminateStaleApplicationInstancesRequest.SerializeToString,
        response_deserializer=protos_dot_untrusted__runner__pb2
        .TerminateStaleApplicationInstancesResponse.FromString,
    )
    self.GetFuzzTargets = channel.unary_unary(
        "/UntrustedRunner/GetFuzzTargets",
        request_serializer=protos_dot_untrusted__runner__pb2
        .GetFuzzTargetsRequest.SerializeToString,
        response_deserializer=protos_dot_untrusted__runner__pb2
        .GetFuzzTargetsResponse.FromString,
    )
    self.PruneCorpus = channel.unary_unary(
        "/UntrustedRunner/PruneCorpus",
        request_serializer=protos_dot_untrusted__runner__pb2.PruneCorpusRequest
        .SerializeToString,
        response_deserializer=protos_dot_untrusted__runner__pb2
        .PruneCorpusResponse.FromString,
    )
    self.ProcessTestcase = channel.unary_unary(
        "/UntrustedRunner/ProcessTestcase",
        request_serializer=protos_dot_untrusted__runner__pb2
        .ProcessTestcaseRequest.SerializeToString,
        response_deserializer=protos_dot_untrusted__runner__pb2
        .EngineReproduceResult.FromString,
    )
    self.EngineFuzz = channel.unary_unary(
        "/UntrustedRunner/EngineFuzz",
        request_serializer=protos_dot_untrusted__runner__pb2.EngineFuzzRequest
        .SerializeToString,
        response_deserializer=protos_dot_untrusted__runner__pb2
        .EngineFuzzResponse.FromString,
    )
    self.EngineReproduce = channel.unary_unary(
        "/UntrustedRunner/EngineReproduce",
        request_serializer=protos_dot_untrusted__runner__pb2
        .EngineReproduceRequest.SerializeToString,
        response_deserializer=protos_dot_untrusted__runner__pb2
        .EngineReproduceResult.FromString,
    )
