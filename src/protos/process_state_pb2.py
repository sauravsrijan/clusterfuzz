...
# source: protos/process_state.proto
...
_PROCESSSTATEPROTO_CRASH = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="reason",
            full_name="ProcessStateProto.Crash.reason",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="address",
            full_name="ProcessStateProto.Crash.address",
            index=1,
            number=2,
            type=3,
            cpp_type=2,
...
_PROCESSSTATEPROTO_THREAD = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="frames",
            full_name="ProcessStateProto.Thread.frames",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_PROCESSSTATEPROTO = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name="ProcessStateProto.time_date_stamp",
            index=0,
            number=1,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="ProcessStateProto.process_create_time",
            index=1,
            number=13,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name="assertion",
            full_name="ProcessStateProto.assertion",
            index=3,
            number=3,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="requesting_thread",
            full_name="ProcessStateProto.requesting_thread",
            index=4,
            number=4,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="threads",
            full_name="ProcessStateProto.threads",
            index=5,
            number=5,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="modules",
            full_name="ProcessStateProto.modules",
            index=6,
            number=6,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="os",
            full_name="ProcessStateProto.os",
            index=7,
            number=7,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="os_short",
            full_name="ProcessStateProto.os_short",
            index=8,
            number=8,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="os_version",
            full_name="ProcessStateProto.os_version",
            index=9,
            number=9,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="cpu",
            full_name="ProcessStateProto.cpu",
            index=10,
            number=10,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="cpu_info",
            full_name="ProcessStateProto.cpu_info",
            index=11,
            number=11,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="cpu_count",
            full_name="ProcessStateProto.cpu_count",
            index=12,
            number=12,
            type=5,
            cpp_type=1,
...
_STACKFRAME = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="instruction",
            full_name="StackFrame.instruction",
            index=0,
            number=1,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name="function_name",
            full_name="StackFrame.function_name",
            index=2,
            number=3,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="function_base",
            full_name="StackFrame.function_base",
            index=3,
            number=4,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="StackFrame.source_file_name",
            index=4,
            number=5,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="source_line",
            full_name="StackFrame.source_line",
            index=5,
            number=6,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="source_line_base",
            full_name="StackFrame.source_line_base",
            index=6,
            number=7,
            type=3,
            cpp_type=2,
...
_CODEMODULE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="base_address",
            full_name="CodeModule.base_address",
            index=0,
            number=1,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name="code_file",
            full_name="CodeModule.code_file",
            index=2,
            number=3,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="CodeModule.code_identifier",
            index=3,
            number=4,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="debug_file",
            full_name="CodeModule.debug_file",
            index=4,
            number=5,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="CodeModule.debug_identifier",
            index=5,
            number=6,
            type=9,
            cpp_type=9,
...
ProcessStateProto = _reflection.GeneratedProtocolMessageType(
    "ProcessStateProto",
    (_message.Message,),
    dict(
        Crash=_reflection.GeneratedProtocolMessageType(
            "Crash",
            (_message.Message,),
            dict(
                DESCRIPTOR=_PROCESSSTATEPROTO_CRASH,
                __module__="protos.process_state_pb2"
                # @@protoc_insertion_point(class_scope:ProcessStateProto.Crash)
            ),
        ),
        Thread=_reflection.GeneratedProtocolMessageType(
            "Thread",
            (_message.Message,),
            dict(
...
CodeModule = _reflection.GeneratedProtocolMessageType(
    "CodeModule",
    (_message.Message,),
    dict(
