...
MUTATOR_PLUGIN_RADAMSA_STRATEGY = Strategy(
    name="mutator_plugin_radamsa", probability=0.20, manually_enable=False
)
...
assert set(LIBFUZZER_STRATEGY_LIST) == set(
    LIBFUZZER_STRATEGIES_WITH_PREFIX_VALUE + LIBFUZZER_STRATEGIES_WITH_BOOLEAN_VALUE
)
