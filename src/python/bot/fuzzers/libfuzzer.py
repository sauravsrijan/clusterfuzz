...
class LibFuzzerRunner(new_process.ProcessRunner, LibFuzzerCommon):
    ...
    def get_command(self, additional_args=None):
        ...
        base_command = super(LibFuzzerRunner, self).get_command(
            additional_args=additional_args
        )
...
class MinijailLibFuzzerRunner(
    engine_common.MinijailEngineFuzzerRunner, LibFuzzerCommon
):
...
def pick_strategies(strategy_pool, fuzzer_path, corpus_directory, existing_arguments):
    """Pick strategies."""
