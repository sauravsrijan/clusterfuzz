...
class AddFiltersTest(unittest.TestCase):
    ...
    def test_both_fields(self):
        ...
        self.params["q"] = (
            "hello group:456 issue:123 platform:windows"
...
class JsonHandlerTest(unittest.TestCase):
    ...
    def test_domain_with_job_and_fuzzer(self):
        ...
        self.mock._allowed_entities_for_user.side_effect = [
            ["job"],
            ["fuzzer"],
        ...
        self.assertListEqual(
            [
                self.testcases[5].key.id(),
                self.testcases[6].key.id(),
                self.testcases[7].key.id(),
                self.testcases[8].key.id(),
            ],
