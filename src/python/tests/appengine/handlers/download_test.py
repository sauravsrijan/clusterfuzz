...
class DownloadTest(unittest.TestCase):
  ...
  def _test_download(
    ...
    if expect_filename:
      expected_url += ("&response-content-disposition="
                       "attachment%3B+filename%3D" +
                       urllib.parse.quote(expect_filename))
  ...
  def test_download_filename(self):
    ...
    expect_filename = ("clusterfuzz-testcase-minimized-%s.ext" %
