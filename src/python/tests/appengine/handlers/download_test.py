...
class DownloadTest(unittest.TestCase):
    ...
    def test_download_not_logged_in(self):
        ...
        self._test_download(
            self.fuzzed_key, expect_status=302, expect_blob=False)
        self._test_download(
            self.unused_key, expect_status=302, expect_blob=False)
    ...
    def test_download_testcase_user(self):
        ...
        self._test_download(
            self.fuzzed_key, expect_status=403, expect_blob=False)
        self._test_download(
            self.unused_key, expect_status=403, expect_blob=False)
    ...
    def test_download_invalid_id(self):
        ...
        self.mock.has_access.return_value = True
        self._test_download(
            testcase_id=1337, expect_blob=False, expect_status=400)
        self._test_download(
            self.minimized_key,
            testcase_id=1337,
            expect_blob=False,
    ...
    def test_download_filename(self):
        ...
        expect_filename = ('clusterfuzz-testcase-%s.ext' %
