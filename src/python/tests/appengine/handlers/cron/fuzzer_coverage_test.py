...
class HandlerTest(unittest.TestCase):
    ...
    def assertCoverageInformation(
        ...
        self.assertEqual(actual.corpus_backup_location, expected.corpus_backup_location)
        self.assertEqual(actual.quarantine_size_units, expected.quarantine_size_units)
        self.assertEqual(actual.quarantine_size_bytes, expected.quarantine_size_bytes)
