...
class OssFuzzProjectSetupTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        data_types.ExternalUserPermission(
            ...
            email="willberemoved@example.com",
        ).put()
    ...
    def test_execute(self):
        ...
        self.mock.get_oss_fuzz_projects.return_value = [
            (
                "lib1",
                {
                    ...
                    "auto_ccs": ["User@example.com", "user2@googlemail.com",],
                },
            ),
            (
                "lib2",
        ...
        six.assertCountEqual(self, job.templates, ["engine_asan", "libfuzzer", "prune"])
        self.assertEqual(
        ...
        six.assertCountEqual(self, afl.jobs, ["afl_asan_lib1", "afl_asan_lib6",])
        ...
        six.assertCountEqual(
            self, expected_topics, list(pubsub_client.list_topics("projects/" + app_id))
        )
...
class GenericProjectSetupTest(unittest.TestCase):
    ...
    def test_execute(self):
        ...
        six.assertCountEqual(self, ["engine_asan", "libfuzzer", "prune"], job.templates)
        ...
        libfuzzer = data_types.Fuzzer.query(data_types.Fuzzer.name == "libFuzzer").get()
        six.assertCountEqual(
            self, ["libfuzzer_asan_a-b", "old_unmanaged",], libfuzzer.jobs
        )
        ...
        six.assertCountEqual(self, ["honggfuzz_asan_a-b",], honggfuzz.jobs)
