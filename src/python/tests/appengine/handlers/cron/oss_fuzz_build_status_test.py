...
class OssFuzzBuildStatusTest(unittest.TestCase):
    ...
    def setUp(self):
        self.app = webtest.TestApp(
            webapp2.WSGIApplication([("/build-status", oss_fuzz_build_status.Handler)])
        )
    ...
    def test_build_failures(self):
        ...
        data_types.OssFuzzProject(id="proj2", name="proj2", ccs=["a@user.com"]).put()
        data_types.OssFuzzProject(id="proj6", name="proj7", ccs=["b@user.com"]).put()
    ...
    def test_reminder(self):
        ...
        data_types.OssFuzzProject(id="proj0", name="proj0", ccs=["a@user.com"]).put()
        data_types.OssFuzzBuildFailure(
            id="proj0",
            project_name="proj0",
            last_checked_timestamp=datetime.datetime(2018, 1, 31),
        ...
        data_types.OssFuzzProject(id="proj1", name="proj1", ccs=["a@user.com"]).put()
        data_types.OssFuzzBuildFailure(
            id="proj1",
            project_name="proj1",
            last_checked_timestamp=datetime.datetime(2018, 1, 31),
