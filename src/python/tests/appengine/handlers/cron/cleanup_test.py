...
class GetJobsAndPlatformsForProjectTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        data_types.Job(
            name="job5", platform="LINUX", environment_string=("PROJECT_NAME=project5")
        ).put()
        data_types.Job(
            name="job6", platform="MAC", environment_string=("PROJECT_NAME=project6")
        ).put()
...
class UpdateIssueCCsFromOwnersFileTest(unittest.TestCase):
    ...
    def test_skipped_ccs_alread_added_and_metadata_set(self):
        ...
        six.assertCountEqual(
            self, ["dev1@example1.com", "dev2@example2.com"], sorted(self.issue.ccs)
        )
        self.assertNotIn("ClusterFuzz-Auto-CC", self.issue.labels)
