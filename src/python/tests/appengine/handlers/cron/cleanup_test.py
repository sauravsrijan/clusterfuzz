...
class CleanupTest(unittest.TestCase):
    ...
    def test_mark_issue_as_closed_if_testcase_is_fixed_3(self):
        ...
        self.assertIn(
            "ClusterFuzz testcase 1 is verified as fixed.",
    ...
    def test_mark_testcase_as_closed_if_job_is_invalid_1(self):
        ...
        cleanup.mark_testcase_as_closed_if_job_is_invalid(testcase=testcase, jobs=jobs)
        self.assertTrue(testcase.open)
    ...
    def test_mark_unreproducible_testcase_and_issue_as_closed_after_deadline_1(self):
        """Ensure that a reproducible testcase with no associated issue is not
        closed."""
        testcase = test_utils.create_generic_testcase()
        testcase.bug_information = ""
    ...
    def test_mark_unreproducible_testcase_and_issue_as_closed_after_deadline_2(self):
    ...
    def test_mark_unreproducible_testcase_and_issue_as_closed_after_deadline_3(self):
    ...
    def test_mark_unreproducible_testcase_and_issue_as_closed_after_deadline_4(self):
    ...
    def test_mark_unreproducible_testcase_and_issue_as_closed_after_deadline_5(self):
    ...
    def test_mark_unreproducible_testcase_and_issue_as_closed_after_deadline_6(self):
        """Ensure that an unreproducible testcase with an open issue, with crash not
    ...
    def test_mark_unreproducible_testcase_and_issue_as_closed_after_deadline_7(self):
        """Ensure that an unreproducible testcase with an open issue, with crash not
    ...
    def test_mark_unreproducible_testcase_and_issue_as_closed_after_deadline_8(self):
        ...
        self.mock.get_crash_occurrence_platforms.return_value = ["Linux"]
        testcase = test_utils.create_generic_testcase(
            created_days_ago=data_types.UNREPRODUCIBLE_TESTCASE_WITH_BUG_DEADLINE - 1
        )
        testcase.bug_information = str(self.issue.id)
        testcase.one_time_crasher_flag = True
        testcase.put()
    ...
    def test_mark_unreproducible_testcase_and_issue_as_closed_after_deadline_9(self):
        """Ensure that an unreproducible testcase with an open issue, with crash not
    ...
    def test_mark_unreproducible_testcase_and_issue_as_closed_after_deadline_10(self):
        """Ensure that an unreproducible testcase with an open issue, with crash not
    ...
    def test_mark_unreproducible_testcase_and_issue_as_closed_after_deadline_11(self):
        """Ensure that an unreproducible testcase with an open issue, with crash not
    ...
    def test_mark_unreproducible_testcase_and_issue_as_closed_after_deadline_12(self):
        """Ensure that an unreproducible testcase with an open issue, with crash not
...
class UpdateOsLabelsTest(unittest.TestCase):
    ...
    def setUp(self):
        helpers.patch(self, ["metrics.crash_stats.get"])
        self.policy = issue_tracker_policy.get("test-project")
    ...
    def test_labels_added(self):
        ...
        self.assertEqual(
            {"OS-Windows", "OS-Linux", "OS-Mac", "OS-Android"}, set(issue.labels)
        )
        self.mock.get.assert_called_once_with(
            ...
            group_by="platform",
            where_clause=(
                'crash_type = "type" AND crash_state = "state" AND '
...
class GetJobsAndPlatformsForTopCrashesTest(unittest.TestCase):
    ...
    def setUp(self):
        data_types.Job(
            name="job1", platform="LINUX", environment_string=("EXPERIMENTAL = True\n")
        ).put()
        data_types.Job(
            name="job2", platform="MAC", environment_string=("CUSTOM_BINARY = True\n")
        ).put()
        data_types.Job(
            name="job3",
            platform="WINDOWS",
    ...
    def test(self):
        actual_jobs, actual_platforms = cleanup.get_jobs_and_platforms_for_top_crashes()
...
class GetTopCrashesForAllProjectsAndPlatforms(unittest.TestCase):
    ...
    def setUp(self):
        helpers.patch(
            self,
            ["metrics.crash_stats.get", "metrics.crash_stats.get_last_successful_hour"],
        )
        ...
        data_types.Job(
            name="job", platform="LINUX", environment_string=("PROJECT_NAME = project")
        ).put()
...
class UpdateTopCrashLabelsTest(unittest.TestCase):
    ...
    def test_no_top_crashes(self):
        ...
        cleanup.update_fuzz_blocker_label(
            self.policy,
            self.testcase,
            self.issue,
        ...
        self.assertNotIn(
            data_types.CHROMIUM_ISSUE_RELEASEBLOCK_BETA_LABEL, self.issue.labels
        )
...
class UpdateComponentsTest(unittest.TestCase):
    ...
    def test_components_added(self):
        ...
        self.testcase.set_metadata(
            "predator_result", {"result": {"suspected_components": ["A", "B>C"]}}
        )
    ...
    def test_no_label_added_for_more_specific_component(self):
        ...
        already."""
        self.testcase.set_metadata(
            "predator_result", {"result": {"suspected_components": ["A"]}}
        )
    ...
    def test_label_added_for_more_specific_component_and_new_component(self):
        ...
        self.testcase.set_metadata(
            "predator_result", {"result": {"suspected_components": ["A", "E"]}}
        )
        self.issue.components.add("A>B")
        self.issue.components.add("D")
        cleanup.update_component_labels(self.testcase, self.issue)
...
class UpdateIssueCCsFromOwnersFileTest(unittest.TestCase):
    ...
    def test_skipped_issue_closed(self):
        ...
        self.issue.status = "Fixed"
        self.issue._monorail_issue.open = False
        cleanup.update_issue_ccs_from_owners_file(
    ...
    def test_skipped_ccs_alread_added_and_metadata_set(self):
        ...
        self.assertItemsEqual(
            ["dev1@example1.com", "dev2@example2.com"], sorted(self.issue.ccs)
        )
        self.assertNotIn("ClusterFuzz-Auto-CC", self.issue.labels)
...
class UpdateIssueLabelsForFlakyTestcaseTest(unittest.TestCase):
    ...
    def test_mark_unreproducible_if_reproducible_change(self):
        ...
        self.testcase.put()
        cleanup.update_issue_labels_for_flaky_testcase(
            self.policy, self.testcase, self.issue
        )
        ...
        self.assertEqual(
            ...
            "updating reproducibility label.",
            self.issue._monorail_issue.comment,
        )
...
class UpdateIssueOwnerAndCCsFromPredatorResultsTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.testcase.set_metadata(
            "predator_result",
            {
                "result": {
                    "suspected_cls": [
                        {"author": "a@example.com", "description": "blah", "url": "url"}
                    ]
                }
            },
        )
    ...
    def test_skipped_if_no_cls(self):
        ...
        self.testcase.set_metadata("predator_result", {"result": {"suspected_cls": []}})
    ...
    def test_skipped_if_malformed_cl(self):
        ...
        self.testcase.set_metadata(
            "predator_result", {"result": {"suspected_cls": [{"url": "url"}]}}
        )
...
class NotifyIssueIfTestcaseIsInvalidTest(unittest.TestCase):
    ...
    def test_skipped_if_no_issue(self):
        ...
        cleanup.notify_issue_if_testcase_is_invalid(self.policy, self.testcase, None)

    def test_skipped_if_closed_issue(self):
        """Ensure that we ignore issues that are already closed."""
        self.issue.status = "Fixed"
        self.issue._monorail_issue.open = False
        cleanup.notify_issue_if_testcase_is_invalid(
            self.policy, self.testcase, self.issue
        )
        self.assertEqual(self.issue._monorail_issue.comment, "")
    ...
    def test_notified_if_fuzzer_was_deleted(self):
        ...
        self.assertIn(
            "is associated with an obsolete fuzzer", self.issue._monorail_issue.comment
        )
...
class NotifyUploaderIfTestcaseIsProcessed(unittest.TestCase):
    ...
    def _get_notification(self):
        ...
        return data_types.Notification.query(
            data_types.Notification.testcase_id == self.testcase_id
        ).get()
    ...
    def test_upload_metadata_with_no_uploader_email(self):
        ...
        data_types.TestcaseUploadMetadata(
            testcase_id=self.testcase_id, uploader_email=None, bundled=False
        ).put()
        cleanup.notify_uploader_when_testcase_is_processed(
            self.policy, self.testcase, self.issue
        )
    ...
    def test_notification_sent_with_regular_testcase(self):
        ...
        self.mock.send.assert_called_once_with(
            "uploader@email.com",
            "Your testcase upload 1 analysis is complete.",
...
class CleanupUnusedFuzzTargetsTest(unittest.TestCase):
    ...
    def test_cleanup_unused_fuzz_targets_and_jobs(self):
        ...
        data_types.FuzzTarget(
            engine="libFuzzer", binary="binary1", project="test-project"
        ).put()
        data_types.FuzzTargetJob(
            fuzz_target_name="libFuzzer_binary1",
            job="job1",
            last_run=datetime.datetime(2018, 1, 15),
        ).put()

        # FuzzTarget should be removed. No FuzzTargetJobs.
        data_types.FuzzTarget(
            engine="libFuzzer", binary="binary2", project="test-project"
        ).put()

        # FuzzTarget should not be removed. Has 1 FuzzTargetJob left after removing
        # old ones.
        data_types.FuzzTarget(
            engine="libFuzzer", binary="binary3", project="test-project"
        ).put()
        data_types.FuzzTargetJob(
            fuzz_target_name="libFuzzer_binary3",
            job="job1",
            last_run=datetime.datetime(2018, 1, 20),
        ).put()
        data_types.FuzzTargetJob(
            fuzz_target_name="libFuzzer_binary3",
            job="job2",
        ...
        data_types.FuzzTarget(
            engine="libFuzzer", binary="binary4", project="test-project"
        ).put()
        data_types.FuzzTargetJob(
        ...
        self.assertItemsEqual(
            [
                "libFuzzer_binary3/job1",
                "libFuzzer_binary4/job1",
