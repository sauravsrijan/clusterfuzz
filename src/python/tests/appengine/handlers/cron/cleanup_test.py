...
class CleanupTest(unittest.TestCase):
    ...
    def test_mark_duplicate_testcase_as_closed_with_no_issue_1(self):
        ...
        testcase.put()
        cleanup.mark_duplicate_testcase_as_closed_with_no_issue(
            testcase=testcase)
    ...
    def test_mark_unreproducible_testcase_and_issue_as_closed_after_deadline_11(
        ...
        testcase.one_time_crasher_flag = True
        testcase.put()
        testcase.set_metadata('last_tested_crash_time',
...
class GetJobsAndPlatformsForTopCrashesTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        data_types.Job(name='job5', platform='LINUX',
                       environment_string=('')).put()
        data_types.Job(name='job6', platform='MAC',
                       environment_string=('')).put()
...
class NotifyUploaderIfTestcaseIsProcessed(unittest.TestCase):
    ...
    def setUp(self):
        ...
        data_types.Config(
            url='url', reproduction_help_url='repro_help_url').put()
...
class CleanupUnusedHeartbeatsTest(unittest.TestCase):
    ...
    def test_cleanup(self):
        ...
        data_types.Heartbeat(
            last_beat_time=datetime.datetime(2018, 1, 14)).put()
        data_types.Heartbeat(
            last_beat_time=datetime.datetime(2018, 1, 15)).put()
        data_types.Heartbeat(
            last_beat_time=datetime.datetime(2018, 1, 16)).put()
        data_types.Heartbeat(
            last_beat_time=datetime.datetime(2018, 1, 17)).put()
        data_types.Heartbeat(
            last_beat_time=datetime.datetime(2018, 2, 1)).put()
