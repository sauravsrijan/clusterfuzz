...
class ConvertToLinesTest(unittest.TestCase):
    ...
    def test_convert(self):
        ...
        self.assertEqual(
            expected, show.convert_to_lines("a\nb\nc\nd\ne", ["b", "c"], "d")
        )
...
class PreviewStacktraceTest(unittest.TestCase):
    ...
    def test_preview_middle_and_end(self):
        ...
        expected = self._make([3, "x", "x", "x", "t-c", "t-d", "t-e", "x", "x", "x", 1])
    ...
    def test_preview_two_parts_hit_limit(self):
        ...
        expected = self._make([3, "x", "x", "x", "t-c", "t-d", "t-e", "x", 13])
...
class FilterStacktraceTest(unittest.TestCase):
    ...
    def setUp(self):
        test_helpers.patch(
            self, ["handlers.testcase_detail.show.highlight_common_stack_frames"]
        )
    ...
    def test_asan_chromium(self):
        ...
        stack = "\n".join([r"#1 0xa6760 in Test /build/src/v8/src/api.cc:3", r"random"])
    ...
    def test_asan_v8(self):
        ...
        stack = "\n".join(
            [
                (
                    r"v8::internal::RootVisitor::VisitRootPointer "
        ...
        expected = (
            "v8::internal::RootVisitor::VisitRootPointer [0x011517C5+53] "
...
class GetTestcaseTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.mock.get_component_range_list.return_value = [
            {"component": "name", "link_text": "0:revision"}
        ]

        self.mock.get_component_revisions_dict.return_value = {
            "/src": {"name": "name", "rev": "revision"}
        }
    ...
    def test_reproducible_get(self):
        ...
        expected_subset = {
            ...
            "fuzzer_display": collections.OrderedDict(
                [
                    ("engine", None),
                    ("target", None),
                    ("name", "fuzzer1"),
    ...
    def test_unreproducible_get(self):
        ...
        expected_subset = {
            ...
            "fixed": "NO",
            "issue_url": "issue_url",
            "metadata": {"fuzzer_binary_name": "test_fuzzer"},
            "minimized_testcase_size": None,
            "needs_refresh": True,
            "original_testcase_size": None,
            "privileged_user": False,
            ...
            "fuzzer_display": collections.OrderedDict(
                [
                    ...
                    ("target", "test_fuzzer"),
                    ("name", "libFuzzer"),
                    ("fully_qualified_name", "libFuzzer_test_fuzzer"),
                ]
            ),
        }
