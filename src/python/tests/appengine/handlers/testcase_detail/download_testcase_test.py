...
class OAuthHandlerTest(unittest.TestCase):
    ...
    def _test_download(self, handler_class):
        ...
        self.assertEqual(
            ...
            "%3B+filename%3Dtestcase-1-file.tar.gz",
            resp.location,
        )
...
class GetTestcaseBlobInfoTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        test_helpers.patch(self, ["google_cloud_utils.blobs.get_blob_info",])
    ...
    def test_minimized(self):
        ...
        blob_info, using_minimized_keys = download_testcase.get_testcase_blob_info(
            self.testcase
        )
