...
class GetAccessTest(unittest.TestCase):
    ...
    def test_get_access_allowed_domain(self):
        ...
        self.assertEqual(
            access.get_access(need_privileged_access=False), access.UserAccess.Allowed
        )
        self.assertEqual(
    ...
    def test_get_access_external_job(self):
        ...
        self.assertEqual(access.get_access(job_type="test"), access.UserAccess.Allowed)
        self.assertEqual(access.get_access(), access.UserAccess.Denied)
...
class HasAccessTest(unittest.TestCase):
    ...
    def setUp(self):
        test_helpers.patch(self, ["libs.access.get_access",])
...
class CanUserAccessTestcaseTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.mock.get_issue_tracker_for_testcase.return_value = monorail.IssueTracker(
            self.itm
        )
        ...
        self.mock.get.return_value = data_types.Config(relax_testcase_restrictions=True)
        self.mock._is_domain_allowed.return_value = False
    ...
    def test_allowed_because_of_owner_in_original_issue(self):
        ...
        self.mock.get_original_issue.return_value = monorail.Issue(self.original_bug)
        self._test_bug_access()
    ...
    def test_allowed_security_bug_access_for_domain_user(self):
        ...
        self.testcase.security_flag = True
        self.mock.get.return_value = data_types.Config(
            relax_security_bug_restrictions=True
        )
