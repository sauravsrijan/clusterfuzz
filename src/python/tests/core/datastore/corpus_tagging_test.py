...
class CorpusTaggingTest(unittest.TestCase):
    ...
    def test_get_targets_with_correct_tag(self):
        ...
        data_types.CorpusTag(
            tag="test_tag", fully_qualified_fuzz_target_name="test_fuzz_target"
        ).put()

        self.assertEqual(
            "test_fuzz_target",
            corpus_tagging.get_targets_with_tag("test_tag")[
                0
    ...
    def test_get_all_targets_with_correct_tag(self):
        ...
        matching tag."""
        data_types.CorpusTag(
            tag="test_tag", fully_qualified_fuzz_target_name="test_fuzz_target1"
        ).put()
        ...
        data_types.CorpusTag(
            tag="not_the_same_tag", fully_qualified_fuzz_target_name="test_fuzz_target3"
        ).put()
    ...
    def test_get_target_with_correct_tag_when_target_has_multiple_tags(self):
        ...
        data_types.CorpusTag(
            tag="test_tag2", fully_qualified_fuzz_target_name="test_fuzz_target"
        ).put()
    ...
    def test_get_tag_from_target_with_one_tag(self):
        ...
        self.assertEqual(
            "test_tag", corpus_tagging.get_fuzz_target_tags("test_fuzz_target")[0].tag
        )
    ...
    def test_get_tags_from_target_with_multiple_tags(self):
        ...
        tags = [i.tag for i in corpus_tagging.get_fuzz_target_tags("test_fuzz_target")]
    ...
    def test_get_similarly_tagged_fuzzers_returns_with_correct_values(self):
        ...
        data_types.CorpusTag(
            tag="test_tag", fully_qualified_fuzz_target_name="test_fuzz_target_2"
        ).put()
