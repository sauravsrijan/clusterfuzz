...
class DeployTest(fake_filesystem_unittest.TestCase):
    ...
    def _check_env_variables(self, yaml_paths):
        ...
        for yaml_path in yaml_paths:
            ...
            self.assertEqual(
                "test-quarantine-bucket", env_variables["QUARANTINE_BUCKET"]
            )
            self.assertEqual(
                "test-shared-corpus-bucket", env_variables["SHARED_CORPUS_BUCKET"]
            )
    ...
    def test_app(self):
        ...
        deploy._prod_deployment_helper(
            "/config_dir", ["/windows.zip", "/mac.zip", "/linux.zip"], deploy_go=True
        )
        ...
        self.mock.execute.assert_has_calls(
            [
                ...
                mock.call("gsutil cp /mac.zip gs://test-deployment-bucket/" "mac.zip"),
                mock.call(
    ...
    def test_app_without_go(self):
        ...
        deploy._prod_deployment_helper(
            "/config_dir", ["/windows.zip", "/mac.zip", "/linux.zip"], deploy_go=False
        )
...
class FindFileExceedingLimitTest(fake_filesystem_unittest.TestCase):
    ...
    def test_get_too_large_file(self):
        ...
        self.assertEqual(
            "/test/dir1/dir1/too_large", deploy.find_file_exceeding_limit("/test", 5)
        )
...
class GetRemoteShaTest(unittest.TestCase):
    ...
    def test_get(self):
        ...
        self.mock.execute.return_value = (
            0,
            "cbb7f93c7ddc1c3a3c98f45ebf5c3490a0c38e95        refs/heads/master",
        )

        self.assertEqual(
            "cbb7f93c7ddc1c3a3c98f45ebf5c3490a0c38e95", deploy.get_remote_sha()
        )
...
class IsDiffOriginMasterTest(unittest.TestCase):
    ...
    def setUp(self):
        helpers.patch(
            self, ["local.butler.common.execute", "local.butler.deploy.get_remote_sha"]
        )
...
class VersionsToDeleteTest(unittest.TestCase):
    ...
    def test_cutoff(self):
        ...
        self.assertEqual(
            [deploy.Version("1", datetime.datetime(2016, 1, 1, 0, 0), 0.0)], to_delete
        )
