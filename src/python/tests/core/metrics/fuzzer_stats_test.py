...
class FuzzerStatsTest(unittest.TestCase):
    ...
    def test_upload_testcase_run_2_days(self):
        ...
        self.assertItemsEqual(
            self.mock.write_data.call_args_list, expected_calls)
...
class BigQueryStatsTests(unittest.TestCase):
    ...
    def test_parse_stats_column_fields(self):
        ...
        self.assertEqual(fields[5].field_class(),
                         fuzzer_stats.CoverageReportField)
        ...
        self.assertEqual(fields[7].field_class(),
                         fuzzer_stats.CorpusBackupField)
...
class BuiltinFieldTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        cov_info = data_types.CoverageInformation(
            fuzzer='fuzzer2', date=self.today)
        ...
        cov_info = data_types.CoverageInformation(
            fuzzer='fuzzer3', date=self.today)
    ...
    def test_coverage_fields(self):
        ...
        edge_field = fuzzer_stats.BuiltinFieldSpecifier(
            '_EDGE_COV').create(ctx)
        func_field = fuzzer_stats.BuiltinFieldSpecifier(
            '_FUNC_COV').create(ctx)
    ...
    def test_performance_field_by_job(self):
        ...
        data = performance_field.get(
            fuzzer_stats.QueryGroupBy.GROUP_BY_JOB, 'job2')
        self.assertEqual(data.value, 'Performance')
