...
class GetSourceLocationTest(unittest.TestCase):
    ...
    def test_get(self):
        ...
        self.assertTrue(pathname.endswith("src/python/tests/core/metrics/logs_test.py"))
...
class UpdateEntryWithExc(unittest.TestCase):
    ...
    def test_none_exc(self):
        ...
        entry = {
            ...
            "extras": {"test": "value"},
            "message": "original",
            "serviceContext": {"service": "bots"},
            "location": {"path": "source_path", "line": 1234, "method": "new_method"},
        }
...
class FormatRecordTest(unittest.TestCase):
    ...
    def get_record(self):
        ...
        record = mock.Mock(
            ...
            exc_info="exc_info",
            created=10,
            location={"path": "path", "line": 123, "method": "func"},
        )
    ...
    def test_format_record(self):
        ...
        self.mock.update_entry_with_exc.assert_called_once_with(mock.ANY, "exc_info")
...
class EmitTest(unittest.TestCase):
    ...
    def setUp(self):
        helpers.patch(
            self, ["metrics.logs.get_logger", "metrics.logs._is_running_on_app_engine"]
        )
...
class TruncateTest(unittest.TestCase):
    ...
    def test_truncate(self):
        ...
        self.assertEqual(
            "abc\n...5 characters truncated...\nijk", logs.truncate("abcdefghijk", 6)
        )
