...
class UntrustedRunnerIntegrationTest(
    ...
    def test_list_files(self):
        ...
        fuzz_inputs = file_host.rebase_to_worker_root(
            os.environ['FUZZ_INPUTS'])
    ...
    def test_setup_regular_build_fuzz_target(self):
        ...
        launcher_dir = os.path.join(
            'src', 'python', 'bot', 'fuzzers', 'libFuzzer')
    ...
    def test_update_data_bundle(self):
        ...
        fuzzer = data_types.Fuzzer.query(
            data_types.Fuzzer.name == 'fuzzer').get()
        ...
        self.assertTrue(os.path.exists(
            os.path.join(data_bundle_directory, 'a')))
        self.assertTrue(os.path.exists(
            os.path.join(data_bundle_directory, 'b')))
