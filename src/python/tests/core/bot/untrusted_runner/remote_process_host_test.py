...
class RemoteProcessHostTest(unittest.TestCase):
    ...
    def test_run_and_wait(self):
        ...
        process_result = new_process.ProcessResult(
            ["command", "123"], 0, b"output", 60.0, False
        )

        self.mock.stub().RunAndWait.return_value = untrusted_runner_pb2.RunAndWaitResponse(
    ...
    def test_run_process(self):
        ...
        self.mock.stub().RunProcess.return_value = untrusted_runner_pb2.RunProcessResponse(
