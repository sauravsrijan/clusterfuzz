...
class FileHostTest(fake_filesystem_unittest.TestCase):
    ...
    def test_copy_directory_to_worker(self, mock_copy_file_to_worker,
        ...
        mock_copy_file_to_worker.assert_has_calls(
            [
                ...
                mock.call('/host/dir/dir2/file3',
                          '/worker/copied_dir/dir2/file3'),
                mock.call('/host/dir/dir2/file4',
                          '/worker/copied_dir/dir2/file4'),
    ...
    def test_copy_directory_from_worker(self, mock_copy_file_from_worker,
        ...
        self.assertTrue(
            file_host.copy_directory_from_worker('/worker', '/host'))
    ...
    def test_get_cf_worker_path(self):
        ...
        self.assertEqual(
            file_host.rebase_to_worker_root(local_path), '/worker')
    ...
    def test_get_cf_host_path(self):
        ...
        worker_path = os.path.join(
            os.environ['WORKER_ROOT_DIR'], 'a', 'b', 'c')

        self.assertEqual(file_host.rebase_to_host_root(
            worker_path), '/host/a/b/c')
