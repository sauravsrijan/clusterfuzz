...
import mock
from bot.untrusted_runner import config, file_host
...
class FileHostTest(fake_filesystem_unittest.TestCase):
    ...
    def setUp(self):
        test_helpers.patch(self, ["bot.untrusted_runner.host.stub",])
    ...
    def test_copy_directory_to_worker(
        self, mock_copy_file_to_worker, mock_remove_directory
    ):
        ...
        mock_copy_file_to_worker.assert_has_calls(
            [
                ...
                mock.call(
                    "/host/dir/dir2/dir3/file5", "/worker/copied_dir/dir2/dir3/file5"
                ),
            ],
            any_order=True,
        )
        ...
        mock_remove_directory.assert_called_with("/worker/copied_dir", recreate=True)
    ...
    def test_copy_directory_from_worker(
        self, mock_copy_file_from_worker, mock_list_files
    ):
    ...
    def test_get_cf_worker_path(self):
        ...
        self.assertEqual(file_host.rebase_to_worker_root(local_path), "/worker/a/b/c")
