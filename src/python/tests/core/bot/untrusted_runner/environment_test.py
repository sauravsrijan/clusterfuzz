...
@mock.patch('bot.untrusted_runner.environment.FORWARDED_ENVIRONMENT_VARIABLES',
            FORWARDED_ENVIRONMENT_VARIABLES)
@mock.patch('bot.untrusted_runner.environment.REBASED_ENVIRONMENT_VARIABLES',
...
class EnvironmentTest(unittest.TestCase):
    ...
    def test_is_forwarded_environment_variable(self):
        ...
        self.assertTrue(
            environment.is_forwarded_environment_variable('REBASED'))
        self.assertFalse(
        ...
        self.assertTrue(
            environment.is_forwarded_environment_variable('AFL_BLAH'))

    def test_should_rebase_environment_value(self):
        """Test should_rebase_environment_value."""
        self.assertTrue(
            environment.should_rebase_environment_value('FUZZER_DIR'))
