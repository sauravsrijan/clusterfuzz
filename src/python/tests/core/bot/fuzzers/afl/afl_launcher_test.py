...
class FuzzingStrategiesTest(fake_filesystem_unittest.TestCase):
    ...
    def setUp(self):
        ...
        test_helpers.patch(
            self, ['bot.fuzzers.engine_common.is_lpm_fuzz_target'])
...
class AflFuzzInputDirectoryTest(LauncherTestBase):
    ...
    def _create_oversized_file(self, directory=None, filename=None):
        ...
        self._create_file(filename, directory=directory,
    ...
    def test_create_new_if_needed(self):
        ...
        self.assertNotIn(self.LARGE_FILENAME,
                         os.listdir(afl_input.input_directory))
    ...
    def test_create_new_if_needed_subdirs(self):
        ...
        self._create_oversized_file(
            directory=subdirectory, filename='too_big_2')
        afl_input = self._new_afl_input()
...
class AflFuzzOutputDirectoryTest(LauncherTestBase):
    ...
    def test_is_new_testcase(self):
        ...
        self.assertTrue(self.afl_output.is_new_testcase(
            self.queue_testcase_path))
    ...
    def test_count_new_units(self):
        ...
        self.assertEqual(self.afl_output.count_new_units(
            self.afl_output.queue), 1)
    ...
    def test_remove_hang_in_queue(self):
        ...
        self.assertIn(self.QUEUE_INPUT_LINK_FILENAME,
                      os.listdir(self.QUEUE_DIR))
        self.afl_output.remove_hang_in_queue(self.queue_input_link_path)
        self.assertNotIn(self.QUEUE_INPUT_LINK_FILENAME,
                         os.listdir(self.QUEUE_DIR))
...
class AflRunnerTest(LauncherTestBase):
    ...
    def test_should_try_fuzzing(self):
        ...
        self.assertFalse(self.runner.should_try_fuzzing(
            time_left, num_retries))
    ...
    def test_prepare_retry_if_cpu_error(self):
        ...
        self.assertFalse(
            self.runner.prepare_retry_if_cpu_error(self.fuzz_result))
...
class ListFullFilePathsTest(LauncherTestBase):
    ...
    def setUp(self):
        ...
        self.dummy_file_path = os.path.join(
            self.INPUT_DIR, fuzzer.AFL_DUMMY_INPUT)
