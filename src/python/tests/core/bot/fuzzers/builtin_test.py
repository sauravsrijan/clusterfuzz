...
class BaseEngineFuzzerTest(fake_filesystem_unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.fs.create_file(
            "/build_dir/target.owners", contents="dev1@example1.com\ndev2@example2.com"
        )
...
class EngineFuzzerTest(BaseEngineFuzzerTest):
    ...
    def test_sanitizer_options_from_options_file(self):
        ...
        self.assertEqual(
            "fake_option1=1:fake_option2=1", environment.get_value("ASAN_OPTIONS")
        )
...
class GetFuzzerPath(unittest.TestCase):
    ...
    @parameterized.parameterized.expand(
        [("fuzzer", "LINUX"), ("fuzzer.exe", "WINDOWS")]
    )
    def test_get_fuzzer_path(self, target_name, mock_platform):
        ...
        result = builtin._get_fuzzer_path(
            ["a", target_path], "fuzzer"
