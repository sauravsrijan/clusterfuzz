...
class TestDefaultStrategySelectionLibFuzzerPatched(unittest.TestCase):
    ...
    def test_default_pool_deterministic(self):
        ...
        self.assertTrue(strategy_pool.do_strategy(strategy.RANDOM_MAX_LENGTH_STRATEGY))
        self.assertTrue(
...
class TestMultiArmedBanditStrategySelectionLibFuzzerPatch(unittest.TestCase):
    ...
    def setUp(self):
        ...
        strategy2.strategy_name = (
            "random_max_len,corpus_mutations_ml_rnn," "value_profile,recommended_dict,"
        )
        ...
        strategy3.strategy_name = (
            "corpus_mutations_radamsa," "random_max_len,corpus_subset,"
        )
