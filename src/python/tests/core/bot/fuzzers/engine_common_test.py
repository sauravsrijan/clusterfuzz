...
class GetIssueOwnersTest(fake_filesystem_unittest.TestCase):
    ...
    def test_no_file(self):
        self.assertEqual([], engine_common.get_issue_owners(
            '/test/does_not_exist'))
...
class GetIssueLabelsTest(fake_filesystem_unittest.TestCase):
    ...
    def test_no_file(self):
        """Test no labels file."""
        self.assertEqual([], engine_common.get_issue_labels(
            '/test/does_not_exist'))
...
class GetStrategyProbabilityTest(unittest.TestCase):
    ...
    def test_default_probability(self):
        ...
        set."""
        self.assertEqual(
            0.33, engine_common.get_strategy_probability('foo', 0.33))
...
class UnpackSeedCorpusIfNeededTest(fake_filesystem_unittest.TestCase):
    ...
    def setUp(self):
        ...
        targz_seed_corpus_path = os.path.join(
            self.data_path, 'seed_corpus.tar.gz')
    ...
    def test_unpack_zip_seed_corpus_if_needed(self):
        ...
        self._write_seed_corpus(
            self.zip_seed_corpus_contents, extension='.zip')
        expected_dir_contents = [
            '0000000000000000', '0000000000000001', '0000000000000002'
        ]
        self._unpack_seed_corpus_if_needed()
        self._assert_elements_equal(
            expected_dir_contents, self._list_corpus_dir())
    ...
    def test_force_unpack(self):
        ...
        self._assert_elements_equal(
            expected_corpus_files, self._list_corpus_dir())
