...
class GetApplicationArgumentsTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        data_types.Job(
            name="libfuzzer_msan_chrome_variant", environment_string=("")
        ).put()
    ...
    def test_no_minimized_arguments(self):
        ...
        self.assertEqual(
            ...
            setup._get_application_arguments(
                self.testcase, "linux_asan_chrome", "minimize"
            ),
        )
        self.assertEqual(
            None,
    ...
    def test_afl_job_for_variant_task(self):
        ...
        self.assertEqual(
            "%TESTCASE%",
            setup._get_application_arguments(
                self.testcase, "afl_asan_chrome_variant", "variant"
            ),
        )
