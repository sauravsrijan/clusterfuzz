...
class AddDefaultIssueMetadataTest(unittest.TestCase):
    ...
    def test_union(self):
        ...
        analyze_task._add_default_issue_metadata(
            testcase
        ...
        self.assertEqual(
            "component1,component2", testcase.get_metadata("issue_components")
        )
        self.assertEqual(
            "label1,label2,label3,label4,label5", testcase.get_metadata("issue_labels")
        )
    ...
    def test_no_testcase_metadata(self):
        ...
        self.assertEqual(
            "dev1@example1.com,dev2@example2.com", testcase.get_metadata("issue_owners")
        )
        self.assertEqual("component1", testcase.get_metadata("issue_components"))
        self.assertEqual("label1,label2,label3", testcase.get_metadata("issue_labels"))
