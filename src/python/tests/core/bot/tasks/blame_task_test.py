...
class ComputeRollsTest(unittest.TestCase):
    ...
    def test(self):
        ...
        actual_rolls = blame_task._compute_rolls(
            start_revisions_dict, end_revisions_dict
        )
...
class PreparePredatorRequestBodyTest(ComponentRevisionPatchingTest):
    ...
    def test_reproducible_no_regression_range(self):
        ...
        expected_result = {
            "result": {
                "error_message": "No regression range, wait for regression task to finish.",
                "feedback_url": "",
                "found": False,
                "project": "",
                "suspected_components": "",
        ...
        expected_message = {
            ...
            "customized_data": {
                ...
                "dependency_rolls": [
                    ...
                    {
                        "new_revision": "97f2aa645b74c28c57eca56992235c79850fa9e0",
                        "dep_path": "src/third_party/gperf",
                        "repo_url": "https://chromium.googlesource.com/chromium/deps/gperf",
                    },
                    {
