...
class FuchsiaBuildTest(unittest.TestCase):
    ...
    def test_setup(self):
        ...
        self.assertEqual('example_fuzzers/trap_fuzzer',
    ...
    def test_setup_nonfuzz(self, unpack_all):
        ...
        class FileMatchCallbackChecker(object):
            ...
            def __eq__(_, file_match_callback):  # pylint: disable=no-self-argument
                ...
                self.assertEqual(file_match_callback.__name__,
                                 'file_match_callback')
                self.assertTrue(isinstance(
                    file_match_callback, types.FunctionType))
                return True
...
class ProductionBuildTest(fake_filesystem_unittest.TestCase):
    ...
    def setUp(self):
        ...
        os.environ['BETA_BUILD_BUCKET_PATH'] = (
            'gs://path/file-beta-([0-9.]+).zip')
...
class RpathsTest(unittest.TestCase):
    ...
    def test_patch_rpaths_no_origins(self):
        ...
        build = build_manager.RegularBuild(
            self.base_build_dir, 1337, 'no-origins')
    ...
    def test_patch_rpaths_prepend(self):
        ...
        self.assertListEqual(
            ['/msan/lib', '/msan/usr/lib', '$ORIGIN/.'], rpaths)
