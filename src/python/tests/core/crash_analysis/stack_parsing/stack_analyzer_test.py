...
class StackAnalyzerTestcase(unittest.TestCase):
    ...
    def test_ubsan_bad_cast_downcast(self):
        ...
        expected_state = (
            "Bad-cast to blink::AXMenuList from blink::AXList\n"
    ...
    def test_ubsan_index_oob(self):
        ...
        expected_address = ""
        expected_state = (
            "CPDF_StreamParser::ParseNextElement\n"
    ...
    def test_ubsan_pointer_overflow(self):
        ...
        expected_address = ""
        expected_state = (
            "SkRasterPipelineBlitter::blitMask\n"
            "blitClippedMask\n"
            "draw_nine_clipped\n"
        )
        expected_stacktrace = data
    ...
    def test_ubsan_pointer_overflow_null_nonzero_offset(self):
        ...
        data = self._read_test_data("ubsan_pointer_overflow_null_nonzero_offset.txt")
        expected_type = "Pointer-overflow"
        expected_address = ""
        expected_state = (
    ...
    def test_ignore_vdso(self):
        ...
        expected_address = ""
        expected_state = (
            "static_cast<unsigned>(text_offset + text_length) "
    ...
    def test_v8_representation_changer_error(self):
        ...
        expected_address = ""
        expected_state = (
            "Int64Constant of kRepWord64 (Internal) cannot be "
    ...
    def test_v8_unknown_fatal_error(self):
        ...
        expected_type = "CHECK failure"
        expected_address = ""
        expected_state = "something that isn't supported yet in " "simulator-arm.cc\n"
        expected_stacktrace = data
        expected_security_flag = False
    ...
    def test_ignore_asan_warning(self):
        ...
        self.assertTrue(
            actual_state.crash_state and "NULL" not in actual_state.crash_state
        )
    ...
    def test_asan_fpe(self):
        ...
        expected_state = (
            "ash::WindowGrid::PositionWindows\n"
    ...
    def test_cdb_divide_by_zero(self):
        ...
        expected_type = "Divide-by-zero"
        expected_state = (
            "ForStatementNode::DetermineLoopIterations<int>\n"
    ...
    def test_kasan_uaf(self):
        ...
        expected_state = (
            "ip6_append_data+ADDRESS/ADDRESS\n"
    ...
    def test_asan_null_dereference_read(self):
        ...
        expected_type = "Null-dereference READ"
        expected_state = (
            "content::NavigationEntryImpl::site_instance\n"
    ...
    def test_security_check_failure(self):
        ...
        expected_address = ""
        expected_state = (
            "startPosition.compareTo(endPosition) <= 0 in "
            "Serialization.cpp\n"
    ...
    def test_security_dcheck_failure(self):
        ...
        expected_address = ""
        expected_state = (
            "!terminated_ in latency_info.cc\n"
    ...
    def test_check_failure_chrome_android(self):
        ...
        expected_address = ""
        expected_state = (
            "Timed out waiting for GPU channel in " "compositor_impl_android.cc\n"
        )
        expected_stacktrace = data
        expected_security_flag = False
    ...
    def test_check_failure_chrome_mac(self):
        ...
        if not environment.is_posix():
            self.skipTest(
                "This test needs c++filt for demangling and is only "
    ...
    def test_check_failure_chrome_win(self):
        ...
        expected_address = ""
        expected_state = (
            "it != device_change_subscribers_.end() in "
    ...
    def test_check_failure_with_handle_sigill_disabled(self):
        ...
        expected_type = "CHECK failure"
        expected_address = ""
        expected_state = "length == 0 || (length > 0 && data != __null) in vector.h\n"
        expected_stacktrace = data
        expected_security_flag = False
    ...
    def test_cobalt_check(self):
        ...
        expected_address = ""
        expected_state = (
            "space_width_ > 0 in font_list.cc\n"
    ...
    def test_libfuzzer_llvm_test_one_input(self):
        ...
        data = self._read_test_data("libfuzzer_llvm_fuzzer_test_one_input_crash.txt")
        expected_type = "Abrt"
    ...
    def test_check_failure_google(self):
        ...
        expected_address = ""
        expected_state = (
            "std::is_sorted(foo.begin(), foo.end()) in file.cc\n" "Frame\n" "path.cc\n"
        )
    ...
    def test_golang_panic_with_type_assertions_in_frames(self):
        ...
        """
        data = self._read_test_data("golang_panic_with_type_assertions_in_frames.txt")
        expected_type = "ASSERT"
        expected_address = ""
        expected_state = (
            "index > windowEnd\n"
    ...
    def test_golang_panic_runtime_error_index_out_of_range(self):
        ...
        data = self._read_test_data("golang_panic_runtime_error_index_out_of_range.txt")
