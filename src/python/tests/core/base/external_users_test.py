...
class ExternalUsersTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        data_types.FuzzTarget(
            engine="parent", binary="child", project="test-project"
        ).put()
        ...
        data_types.FuzzTarget(
            engine="parent", binary="child2", project="test-project"
        ).put()
        data_types.FuzzTargetJob(
    ...
    def test_is_fuzzer_allowed_for_user(self):
        ...
        self.assertTrue(
            external_users.is_fuzzer_allowed_for_user("useR2@example.com", "fuzzer")
        )
        self.assertFalse(
            external_users.is_fuzzer_allowed_for_user("user3@example.com", "fuzzer")
        )
        self.assertFalse(
            external_users.is_fuzzer_allowed_for_user("user4@example.com", "fuzzer")
        )
        self.assertFalse(
            external_users.is_fuzzer_allowed_for_user("user5@example.com", "fuzzer")
        )
        self.assertFalse(
            external_users.is_fuzzer_allowed_for_user("user6@example.com", "fuzzer")
        )
        # No such user.
        self.assertFalse(
            external_users.is_fuzzer_allowed_for_user("notexist@example.com", "fuzzer")
        )

        self.assertFalse(
            external_users.is_fuzzer_allowed_for_user(
                "user1@example.com", "parent_child"
            )
        )
        self.assertFalse(
            external_users.is_fuzzer_allowed_for_user(
                "user2@example.com", "parent_child"
            )
        )
        self.assertTrue(
            external_users.is_fuzzer_allowed_for_user(
                "user3@example.com", "parent_child"
            )
        )
        self.assertFalse(
            external_users.is_fuzzer_allowed_for_user(
                "user4@example.com", "parent_child"
            )
        )
        self.assertFalse(
            external_users.is_fuzzer_allowed_for_user(
                "user5@example.com", "parent_child"
            )
        )
        self.assertFalse(
            external_users.is_fuzzer_allowed_for_user(
                "user6@example.com", "parent_child"
            )
        )
        # No such user.
        self.assertFalse(
    ...
    def test_is_upload_allowed_for_user(self):
        ...
        self.assertFalse(external_users.is_upload_allowed_for_user("user@example.com"))
    ...
    def test_cc_users_for_fuzzer(self):
        ...
        result = external_users.cc_users_for_fuzzer("parent_child", security_flag=True)
