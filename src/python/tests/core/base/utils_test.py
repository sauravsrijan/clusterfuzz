...
class HashTest(unittest.TestCase):
    ...
    def test_hash_equal_for_identical_entities(self):
        ...
        entity_1 = HashTest.DummyEntity.query(
            HashTest.DummyEntity.integer_property == 1
        ).get()
    ...
    def test_hash_different_for_different_entities(self):
        ...
        entity_2 = HashTest.DummyEntity.query(
            HashTest.DummyEntity.integer_property == 2
        ).get()
        hash_2 = utils.entity_hash(entity_2)
...
class NormalizePathTest(unittest.TestCase):
    ...
    def test_redundant_path(self):
        ...
        self.assertEqual(
            "/test/test2/test3", utils.normalize_path("/test/./test2/test3")
        )
        self.assertEqual(
            "/test/test2/test3", utils.normalize_path("/test//test2/test3")
        )
...
class GetCrashStacktraceOutputTest(unittest.TestCase):
    ...
    def test_release_sym_and_unsym_stacks(self):
        ...
        self.assertEqual(
            ...
            + self.end_seperator
            + "\n\nunsym_stack",
            utils.get_crash_stacktrace_output("cmd_line", "sym_stack", "unsym_stack"),
        )
...
class FileHashTest(fake_filesystem_unittest.TestCase):
    ...
    def test_empty_string(self):
        with open(self.test_file, "wb"):
            pass
        self.assertEqual(
            "da39a3ee5e6b4b0d3255bfef95601890afd80709", utils.file_hash(self.test_file)
        )
    ...
    def test_shorter_than_one_chunk(self):
        ...
        self.assertEqual(
            "3c01bdbb26f358bab27f267924aa2c9a03fcfdb8", utils.file_hash(self.test_file)
        )
    ...
    def test_longer_than_one_chunk(self):
        ...
        self.assertEqual(
            "8360c01cef8aa7001d1dd8964b9921d4c187da29", utils.file_hash(self.test_file)
        )
...
class ServiceAccountEmailTest(unittest.TestCase):
    ...
    def test_plain_project_id(self):
        ...
        self.assertEqual(
            "project-id@appspot.gserviceaccount.com", utils.service_account_email()
        )
