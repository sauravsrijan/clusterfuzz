...
class PubSubClient(object):
  ...
  def modify_ack_deadline(self, subscription, ack_ids, seconds):
    ...
    request = (
        self._api_client().projects().subscriptions().modifyAckDeadline(
  ...
  def publish(self, topic, messages):
    ...
    request = (
        self._api_client().projects().topics().publish(
  ...
  def pull_from_subscription(self,
    ...
    request = (
        self._api_client().projects().subscriptions().pull(
  ...
  def list_topics(self, project, page_size=1000):
    """List topics."""
    request = (
        self._api_client().projects().topics().list(
  ...
  def list_topic_subscriptions(self, topic, page_size=1000):
    ...
    request = (
        self._api_client().projects().topics().subscriptions().list(
...
def _raw_message_to_message(client, subscription, raw_message_response):
  ...
  data = base64.b64decode(
      raw_message["data"]) if "data" in raw_message else None
